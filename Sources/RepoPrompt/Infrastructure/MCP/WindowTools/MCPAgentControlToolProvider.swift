    ...
    private func agentExploreTool() -> Tool {
        ...
        return runtime.tool(
            ...
            **Operations**: start | poll | wait | cancel
            ...
            - `wait`: Block until the first referenced explore run finishes or needs input. Omit `timeout` for the default; use shorter waits for closer supervision or longer waits for well-scoped independent work. `timeout=0` behaves like poll.
